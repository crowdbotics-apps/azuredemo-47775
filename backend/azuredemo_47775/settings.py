"""
Django settings for azuredemo_47775 project.
...
ROOT_URLCONF = 'azuredemo_47775.urls'
...
WSGI_APPLICATION = 'azuredemo_47775.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "azuredemo_47775 API",
    "DESCRIPTION": "API documentation for azuredemo_47775 App",
    "VERSION": "v1",
}
